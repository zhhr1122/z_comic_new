...
public class ZBubbleSeekBar extends View {
    ...
    public ZBubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_track_size, BubbleUtils.dp2px(2));
        ...
        mSectionTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_section_text_size, BubbleUtils.sp2px(14));
        ...
        mThumbTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_thumb_text_size, BubbleUtils.sp2px(14));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_bubble_text_size, BubbleUtils.sp2px(14));
